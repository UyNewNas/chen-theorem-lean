...
The complete audit contains fifty-seven reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and forty-nine finite bridge-foundation lemmas.
