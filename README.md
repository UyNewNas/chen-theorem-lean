...
The complete audit contains fifty-two reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and forty-four finite bridge-foundation lemmas.
