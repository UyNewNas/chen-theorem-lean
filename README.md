...
The complete audit contains forty-two reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and thirty-four finite bridge-foundation lemmas.
