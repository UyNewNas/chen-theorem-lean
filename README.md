...
The complete audit contains twenty-five reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and seventeen finite bridge-foundation lemmas.
