...
The complete audit contains fifty reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and forty-two finite bridge-foundation lemmas.
