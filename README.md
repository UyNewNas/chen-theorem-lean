...
The complete audit contains thirty-two reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and twenty-four finite bridge-foundation lemmas.
