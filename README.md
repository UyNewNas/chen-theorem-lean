...
The complete audit contains fifty-six reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and forty-eight finite bridge-foundation lemmas.
