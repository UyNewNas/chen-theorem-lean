...
The complete audit contains forty-six reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and thirty-eight finite bridge-foundation lemmas.
