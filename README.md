...
The complete audit contains thirty reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and twenty-two finite bridge-foundation lemmas.
