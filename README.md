...
The complete audit contains thirty-nine reports: the two conditional derivations,
the three analytic consumers, `primeProduct_asymptotic_order`, the two
pointwise error-budget interfaces, and thirty-one finite bridge-foundation lemmas.
